        ...
        <div class="flex-col">
            ...
            <div class="flex-row px-5 py-2 mt-2 gray-800 border-2 rounded">
                ...
                <div class="flex p-3 mt-2 gray-800 border-2 rounded">
                    ...
                    <div class="px-5 py-1 flex-col justify-between">
                        <div class="flex">
                            <p class="font-medium"> {{ $iklan->shortdesc }} </p>
                        </div>
                        <div class="flex justify-evenly">
                            <div class="flex-col mt-4">
                                <p class="font-medium text-2xl m-5">Lokasi: {{ $iklan->kota_lokasi }} </p>
                                <p class="font-medium text-2xl m-5"> {{ $iklan->durasi }} </p>
                            </div>
                            <div class="flex-col mt-4">
                                <p class="font-medium text-2xl m-5">Rp{{ $iklan->gaji }} </p>
                                <p class="font-medium text-2xl m-5"> {{ $iklan->bidang }} </p>
                            </div>
                        </div>
                        ...
                        <div class="flex mt-6 justify-center">
                            @if (!Auth::check())
                                <form action=" {{route('login')}} " method="get" class="w-full flex justify-center">
                                    <button type="submit"
                                        class="text-white hover:bg-red-600 duration-300 border-2 rounded bg-gray-400 px-2 py-4 w-90">
                                        Login To Apply
                                    </button>
                                </form>
                                @else
                ...
                <div class="flex-col px-5 py-2 mt-3 gray-800 border-2 rounded">
                    <div class="flex mt-1 mb-3">
                        <p class="font-bold text-2xl"> Job Description: </p>
                    </div>
                    @foreach ($jobdesc as $j)
                        <div class="flex mt-1.5">
                            <p class="font-medium"> {{ $j }} </p>
                        </div>
                    @endforeach
                </div>
            <div>
